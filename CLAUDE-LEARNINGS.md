...
**Before doing any work in the codebase**, and again **before troubleshooting any error or
failure**, search this directory first
...
issue update why it doesn't apply) before spending time re-deriving a solution.

**After resolving a novel failure**, add one Markdown file here documenting it. Use the filename
convention `<issue-id>-<short-slug>.md` (e.g. `PROJ-142-alembic-autocommit-block.md`) so
